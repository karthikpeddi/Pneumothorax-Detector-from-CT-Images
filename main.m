...
xlswrite('features.xls',[feature]);
    ...
    sample(i-length(srcFiles)-1,:)=[area.Area,conv_Area.ConvexArea,eccentricity.Eccentricity,equi_diameter.EquivDiameter,perimeter.Perimeter,solidity.Solidity,standard_deviation];
end
end
